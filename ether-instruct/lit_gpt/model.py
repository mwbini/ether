...
class LLaMAMoE(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """
        Implementation derived from: https://github.com/mistralai/mistral-src/blob/b46d6/moe_one_file_ref.py#L203-L219
...
def build_rope_cache(
    ...
    Implementation derived from: https://github.com/labmlai/annotated_deep_learning_paper_implementations/blob/master/labml_nn/
